...
CREATE TABLE IF NOT EXISTS `mykebab`.`kebab` (
  ...
  INDEX `fk_kebab_kebab1_idx` (`kebab_id` ASC) VISIBLE,
  CONSTRAINT `fk_kebab_kebab1`
    FOREIGN KEY (`kebab_id`)
    REFERENCES `mykebab`.`kebab` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mykebab`.`kebab_ingredientes` (
  ...
  PRIMARY KEY (`kebab_id`, `ingrediente_id`),
  INDEX `fk_kebap_has_ingrediente_ingrediente1_idx` (`ingrediente_id` ASC) VISIBLE,
  INDEX `fk_kebap_has_ingrediente_kebap1_idx` (`kebab_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_kebap_has_ingrediente_ingrediente1`
    ...
    REFERENCES `mykebab`.`ingrediente` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mykebab`.`ingrediente_alergenos` (
  ...
  PRIMARY KEY (`ingrediente_id`, `alergenos_id`),
  INDEX `fk_ingrediente_has_alergenos_alergenos1_idx` (`alergenos_id` ASC) VISIBLE,
  INDEX `fk_ingrediente_has_alergenos_ingrediente1_idx` (`ingrediente_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_ingrediente_has_alergenos_alergenos1`
    ...
    REFERENCES `mykebab`.`alergenos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mykebab`.`pedido_kebab` (
  `linea` INT NOT NULL AUTO_INCREMENT COMMENT 'aqui vamos a poner la linea con toda la informacion necesaria, nombre de kebap, ingredientes, precio, cantidad, total',
  `kebab_id` INT NOT NULL,
  ...
  PRIMARY KEY (`linea`),
  INDEX `fk_kebap_has_pedido_kebap1_idx` (`kebab_id` ASC) VISIBLE,
  INDEX `fk_pedido_kebab_pedido1_idx` (`pedido_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mykebab`.`usuario_alergenos` (
  `usuario_id` INT NOT NULL,
  `alergenos_id` INT NOT NULL,
  PRIMARY KEY (`usuario_id`, `alergenos_id`),
  INDEX `fk_usuario_has_alergenos_alergenos1_idx` (`alergenos_id` ASC) VISIBLE,
